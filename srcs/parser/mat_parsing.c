...
/*   Updated: 2016/05/31 09:48:24 by jbelless         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
				...
				double *turb_power, double *turb_size)
{
	...
	*xy_period =
((value = ft_get_inner(perlin, "ring_nb", NULL)) == NULL) ?
														12.0 : ft_atod(value);
	free(value);
	*turb_power =
((value = ft_get_inner(perlin, "turb_power", NULL)) == NULL) ?
														0.1 : ft_atod(value);
	free(value);
	*turb_size =
((value = ft_get_inner(perlin, "turb_size", NULL)) == NULL) ?
														32.0 : ft_atod(value);
	free(value);
}
...
void		ft_set_tex(char *tex, t_obj *obj)
{
	...
	obj->mat.tex.tex =
((value = ft_get_inner(tex, "path", NULL)) == NULL) ? NULL : ft_strdup(value);
	free(value);
	(value = ft_get_inner(tex, "perlin", NULL)) == NULL ?
obj->mat.tex.buf = NULL : ft_set_noise(value, obj);
	free(value);
	obj->mat.tex.height =
((value = ft_get_inner(tex, "height", NULL)) == NULL) ? -70 : ft_atoi(value);
	free(value);
	obj->mat.tex.width =
((value = ft_get_inner(tex, "width", NULL)) == NULL) ? 0 : ft_atoi(value);
	free(value);
	obj->mat.tex.off_x =
((value = ft_get_inner(tex, "offset_x", NULL)) == NULL) ? 0 : ft_atod(value);
	free(value);
	obj->mat.tex.off_y =
((value = ft_get_inner(tex, "offset_y", NULL)) == NULL) ? 0 : ft_atod(value);
	free(value);
}
...
static void	ft_set_mat2(char *mat, t_obj *obj)
{
	...
	obj->mat.refl =
((value = ft_get_inner(mat, "reflection", NULL)) == NULL) ? 0 : ft_atod(value);
	free(value);
	obj->mat.grid =
((value = ft_get_inner(mat, "grid", NULL)) == NULL) ? FALSE : TRUE;
	free(value);
	(value = ft_get_inner(mat, "texture", NULL)) == NULL ?
	obj->mat.tex.tex = NULL : ft_set_tex(value, obj);
	free(value);
	obj->mat.opac =
((value = ft_get_inner(mat, "opac", NULL)) == NULL) ?
1 - obj->mat.refl - obj->mat.refr : ft_atod(value);
	free(value);
	obj->mat.waves =
((value = ft_get_inner(mat, "waves", NULL)) == NULL) ? FALSE : TRUE;
	free(value);
}
...
void		ft_set_mat(char *mat, t_obj *obj)
{
	...
	free(value);
	obj->mat.brim =
((value = ft_get_inner(mat, "brim", NULL)) == NULL) ? 0 : ft_atod(value);
	free(value);
	obj->mat.brip =
((value = ft_get_inner(mat, "brip", NULL)) == NULL) ? 0 : (char)ft_atoi(value);
	free(value);
	obj->mat.i_opt =
((value = ft_get_inner(mat, "indice opt", NULL)) == NULL) ? 1 : ft_atod(value);
	free(value);
	obj->mat.refr =
((value = ft_get_inner(mat, "refraction", NULL)) == NULL) ? 0 : ft_atod(value);
	free(value);
	ft_set_mat2(mat, obj);
}
